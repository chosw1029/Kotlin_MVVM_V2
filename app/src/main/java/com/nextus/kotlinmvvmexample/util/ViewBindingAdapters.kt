...
import com.nextus.kotlinmvvmexample.widget.CustomSwipeRefreshLayout
...
@BindingAdapter("profileUrl", "update")
fun setProfileImage(imageView: ImageView, url: String?, update: String?) {
    url?.let {
        if(it.isNotEmpty() && update != null) {
            ...
            imageView.setImageResource(R.drawable.ic_hero)
    }
}
