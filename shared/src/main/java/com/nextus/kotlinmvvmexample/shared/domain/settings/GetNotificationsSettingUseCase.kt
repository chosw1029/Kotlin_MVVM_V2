...
package com.nextus.kotlinmvvmexample.shared.domain.settings
...
class GetNotificationsSettingUseCase @Inject constructor(
    ...
    override suspend fun execute(parameters: Unit) = preferenceStorage.preferToReceiveCommentAndTagNotifications
}
