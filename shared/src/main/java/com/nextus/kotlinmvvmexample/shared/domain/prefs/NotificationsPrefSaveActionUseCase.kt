...
package com.nextus.kotlinmvvmexample.shared.domain.prefs
...
open class NotificationsPrefSaveActionUseCase @Inject constructor(
    ...
    override suspend fun execute(parameters: Boolean): Boolean {
        preferenceStorage.preferToReceiveCommentAndTagNotifications = parameters
        return preferenceStorage.preferToReceiveCommentAndTagNotifications
    }
}
